...
# coq_makefile -o makefile allGraphs.v CardFin.v EquivContejean.v Extroduce.v Fin.v GPermBij.v GPerm.v Graphs.v IlistMult.v IlistPerm.v Ilist.v Introduce.v IPPJustification.v ListEq.v NatSeg.v Paths.v PermsLists.v Tools.v 
#
